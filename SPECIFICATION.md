...
| NFR-12 | הלוגיקה העסקית תהיה מכוסה בבדיקות יחידה אוטומטיות | מומש חלקית — 147 בדיקות על שכבת הלוגיקה; שכבת הגישה לנתונים אינה מכוסה |
| NFR-13 | המערכת תיפרס כאתר סטטי מול שירותי ענן מנוהלים | מומש |
| NFR-14 | מערך הבדיקות והבנייה יורצו אוטומטית בכל שינוי בקוד, ותוצאתם תוצג בממשק הניהול של המאגר | מומש — הרצה על כל דחיפה לענף הראשי ועל כל בקשת משיכה |
