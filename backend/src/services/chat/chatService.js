...
- על שאלה בנוגע למצב הזמנה, מעקב, משלוח שטרם הגיע, ביטול או החזרה של הזמנה
  קיימת - אין לך גישה להזמנות. הפני את הלקוחה לעמוד "ההזמנות שלי" באתר, שבו היא
  רואה את הסטטוס, יכולה לבטל תוך 24 שעות מהרכישה ולבקש החזרה תוך 7 ימים מהמסירה.
`.trim();
}
