export const he = {
  ...
  customer: {
    ...
    policy: {
      ...
      returnsText:
        "ניתן לבקש החזרה עבור פריטים שנמסרו, דרך עמוד \"ההזמנות שלי\" — לפי כל פריט בנפרד, עד 7 ימים בלבד ממועד המסירה. הבקשה נבדקת על ידי הצוות שלנו, ותקבל/י עדכון באתר ובמייל האם היא אושרה או נדחתה. במקרה של אישור, יינתן זיכוי בכרטיס מתנה בסכום הפריט שהוחזר, לשימוש בקנייה הבאה.",
    ...
    returns: {
      ...
      returnWindowExpired: "חלון ההחזרה (7 ימים) הסתיים",
