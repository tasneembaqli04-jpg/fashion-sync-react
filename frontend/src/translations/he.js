export const he = {
  ...
  manager: {
    ...
    settings: {
      ...
      saveHoursButton: "💾 שמור שעות פעילות",
      saveFailed: "⚠️ השמירה נכשלה. בדקי את החיבור ונסי שוב.",
      hoursErrors: {
      ...
      policySaveButton: "💾 שמור תוכן מדיניות",
  ...
  customer: {
    chat: {
      ...
      requestTimedOut: "לא הצלחתי להשיב הפעם , נסה שוב או שאל משהו אחר.",
  ...
  home: {
    ...
    verification: {
      ...
      close: "סגור",
      likelyFakeEmailHint: "לא קיבלת? בדקי בתיקיית הספאם, או ודאי שהכתובת נכונה.",
      errorSuperseded: "שלחנו קוד חדש — השתמשי בו, הקוד הקודם כבר אינו בתוקף.",
      errorTooManyRequests: "נשלחו יותר מדי קודים לכתובת הזו. נסי שוב בעוד שעה.",
      errorResendFailed: "לא הצלחנו לשלוח קוד חדש. נסי שוב בעוד רגע.",
    },
  },
