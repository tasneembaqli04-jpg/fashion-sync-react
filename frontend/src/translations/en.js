export const en = {
  ...
  manager: {
    ...
    overview: {
      ...
      stockIssues: "Products with a stock issue",
      needsAttention: "Out of stock or running low",
    ...
    settings: {
      ...
      policyTranslateButton: "🌐 Translate to English and save",
      policyTranslatingButton: "Translating…",
      policySavingButton: "⏳ Saving...",
    ...
    alerts: {
      title: "System Alerts",
      subtitle: "Every kind — stock, demand and orders. Kept for one week and updated as products change",
      tabAll: "🔔 All",
