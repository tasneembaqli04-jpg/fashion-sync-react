            ...
            {payMethod === "giftcard" && (
              <div>
                {appliedGiftCardCode ? (
                  ...
                  >
                    <span>
                      {appliedGiftCardCode}: −₪{appliedGiftCardDiscount.toFixed(2)}
                    </span>
                    <button
                      type="button"
                  ...
                  <div className={styles.fg}>
                    ...
                    <div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap" }}>
                      <input
                        ...
                        placeholder="‎GC-... / RTN-...‎"
                        className={giftCardApplyError ? styles.invalid : ""}
                      ...
                      >
                        {t.applyGiftCardButton}
                      </button>
                    </div>
                    {giftCardApplyError && (
                      <div className={styles.fieldErr}>{giftCardApplyError}</div>
                    )}
                  </div>
                )}

                {appliedGiftCardCode && total > 0 && (
                  <div
                    style={{
                      fontSize: "0.82rem",
                      color: errors.needsAnotherMethod ? "#ff6b6b" : "var(--muted)",
                      fontWeight: errors.needsAnotherMethod ? 700 : 400,
                    }}
                  >
                    {t.giftCardPartialNote}
                  </div>
                )}
              </div>
            )}
