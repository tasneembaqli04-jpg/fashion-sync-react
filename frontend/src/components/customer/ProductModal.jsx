        ...
        <div className={modalStyles.pdGrid}>
          ...
          <div>
            ...
            <div className={modalStyles.pdPrice}>
              {isOnSale ? (
                <>
                  <span className={modalStyles.originalPrice}>
                    ₪{product.originalPrice}
                  </span>

                  <span className={modalStyles.salePrice}>
                    ₪{product.price}
                  </span>
                </>
              ) : (
            ...
            <div className={modalStyles.pdRow}>
              ...
              <div className={modalStyles.pdField}>
                ...
                >
                  ...
                  {allSizes.map((size) => {
                    const activeColor =
                      selectedColor || colorsFromVariants[0] || "";
                    ...
                    const displayLabel =
                      size === "אחר" ? t.otherSizeValue : size;

                    return (
                      <option key={size} value={size} disabled={!available}>
                        {displayLabel}
                        {!available ? t.outOfStockSuffix : ""}
                      </option>
                    );
                  })}
                </select>
                    ...
                    return (
                      <div style={{ marginTop: "0.4rem" }}>
                        <input
                          ...
                          placeholder={
                            isNumericCategory
                              ? t.customSizeNumberPlaceholder
                              : t.customSizeLetterPlaceholder
                          }
                          value={customSize}
                          onChange={(e) => {
