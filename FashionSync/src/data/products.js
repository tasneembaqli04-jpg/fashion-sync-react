...
export function normalizeProduct(product) {
  ...
  if (!normalized.season) normalized.season = "all";
  ...
  if (normalized.salesLastMonth === undefined || Number.isNaN(parseInt(normalized.salesLastMonth, 10))) {
...
export const PRODUCTS_SEED = [
  ...
  normalizeProduct({
    ...
    variants: [
      { colorName: "ירוק", colorHex: "#2e8b57", sizes: { XS: 2, S: 1, M: 1, L: 0 } },
