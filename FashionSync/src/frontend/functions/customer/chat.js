export function getReply(message, products) {
  ...
  if (text.includes("נעל") || text.includes("נעליים"))
    return "כן, יש לנו מגוון נעליים בקטלוג — אפשר לסנן לפי הקטגוריה 'נעליים'.";

  if (text.includes("אביזר") || text.includes("אביזרים"))
    return "כן, יש לנו מגוון אביזרים בקטלוג — אפשר לסנן לפי הקטגוריה 'אביזרים'.";
